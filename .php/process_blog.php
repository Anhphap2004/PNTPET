                            ...
                            <div class="col-12 col-sm-7 h-100 d-flex flex-column justify-content-center">
                                <div class="p-4">
                                    <div class="d-flex mb-3">
                                        ...
                                        <small><i class="bi bi-calendar-date me-2 text-danger"></i><?php echo date("d M, Y", strtotime($row['created_at'])); ?></small>
                                    </div>
                                    <h5 class="text-danger text-uppercase mb-3"><?php echo $row['title']; ?></h5>
