    ...
    <div class="container py-5">
        <div class="row g-5">
            <div class="col-lg-8">
                ...
                <!-- Hiển thị bài viết -->
                <div class="mb-5">
                    <img class="img-fluid w-100 rounded mb-5" src="../img/blog/<?php echo htmlspecialchars($row['featured_image']); ?>" alt="">
                    <h1 class="text-uppercase mb-4"><?php echo htmlspecialchars($row['title']); ?></h1>
                ...
                $sql_comments = "SELECT users.profile_image, users.full_name, blog_comments.* 
                 FROM blog_comments Left JOIN users ON users.user_id = blog_comments.user_id 
                 WHERE post_id = ? 
            ...
            <div class="col-lg-4">
                ...
                <div class="mb-5">
                    ...
                    if (isset($_GET['id']) && is_numeric($_GET['id'])) {
                        ...
                        if ($result->num_rows > 0) {
                            $row = $result->fetch_assoc();
                            $image_path = !empty($row['featured_image']) ? '../img/Blog/' . htmlspecialchars($row['featured_image']) : 'uploads/default.jpg';
                        } else {
